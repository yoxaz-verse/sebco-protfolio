  ...
  return (
    <>
      {error ? (
        ...
        <div key={client.name} className={`w-full md:w-[45%] lg:w-[30%] bg-[#2C2B2B] rounded-sm`}>
          <div className="p-5 flex items-center z-10 relative flex-col">
            <Avatar
                ...
                />
               <iframe src={client.link} title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  className="px-3 w-60 h-40 lg:w-72"></iframe>
