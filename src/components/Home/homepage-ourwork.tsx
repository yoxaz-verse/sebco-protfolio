...
const HomepageOurWork = ({data}:HomePageWorkProps) => {
  return (
    <div className='flex flex-col items-center justify-center md:flex-row md:justify-between'>
        <div className='w-9/12 md:w-5/12 lg:w-4/12 shadow-yellow'><Image src={data.image} alt="Architectural Plan" width={100} height={100} className='w-full h-full'/></div>
        <div className=' w-9/12 mt-5 md:mt-0 md:w-6/12 '>
          <div className='text-4xl text-[#FFBD12] font-medium pb-1'>{data.title}</div>
          <div className='flex flex-col pt-3 md:w-10/12 lg:w-8/12'>
